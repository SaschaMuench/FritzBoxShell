...
### ----------------------- General function to print the version of this script ------------------------ ###
### ----------------------------------------------------------------------------------------------------- ###

script_version() {
		echo "fritzBoxShell version: $version"
}


DisplayArguments() {
	echo ""
	echo "Usage: fritzBoxShell [Action] [Parameter]"
	...
	echo "|--------------|------------------------|-------------------------------------------------------------------------|"
	echo "| VERSION      |                        | Version of fritzBoxShell.sh                                             |"
	echo "|--------------|------------------------|-------------------------------------------------------------------------|"
	echo ""
}
